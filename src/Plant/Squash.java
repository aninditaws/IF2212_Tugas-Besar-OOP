...
public class Squash extends Plant {
      ...
      public void attack(GameMap<Object> gameMap) {
            ...
            List<Object> nextColZombies = gameMap.getEntities(position.y, (Math.max(position.x, 10))).stream().filter(entity -> entity instanceof Zombie).collect(Collectors.toList());
