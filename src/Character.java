...
public Character(String name, int health, int attack_damage, int attack_speed)
{
      ...
      public void setAttackDamage(int attack_damage) {this.attack_damage = Math.max(0, attack_damage);}
      public int getAttackDamage()  {return this.attack_damage;}


      public void setAttackSpeed(int attack_speed) {this.attack_speed = Math.max(0,attack_speed);}
